...
git clone https://github.com/wannqn/android_device_xiaomi_renoir -b Rising device/xiaomi/renoir

# Common deivce tree
git clone https://github.com/wannqn/android_device_xiaomi_sm8350-common -b lineage-23.0 device/xiaomi/sm8350-common
...
. build/envsetup.sh
riseup renoir user && gk -s && mka bacon
