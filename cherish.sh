...
git clone https://github.com/wannqn/android_device_xiaomi_renoir -b Cherish device/xiaomi/renoir

# Common deivce tree
git clone https://github.com/wannqn/android_device_xiaomi_sm8350-common -b Cherish device/xiaomi/sm8350-common
...
# Hardware
git clone https://github.com/CherishOS/android_hardware_xiaomi -b sixteen hardware/xiaomi
